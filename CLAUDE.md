...
3. **FKCU Governance Adherence:**
   Every project in the platform MUST map to the 4 faculties (Engineering, Business, Law, Marketing). Any matchmaking logic must enforce the 3-year vesting / 1-year cliff standard and non-dilutive Sandbox funding gates.
